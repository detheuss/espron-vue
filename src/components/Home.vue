      ...
      <b-container>
        ...
        >
          <slide
            ...
            :index="item.id"
          >
            <SmallCarouselItem :item="item" />

          </slide>
        </carousel-3d>
        <div
          class="text-block pb-0 mb-0 mt-5"
          id="howItWorks"
        >
...
<script>
  ...
  import SmallCarouselItem from "./SmallCarouselItem.vue";
  ...
  export default {
    ...
    data() {
      return {
        ...
        //     text: "Color is the place where the mind meets the space.",
        //   },
        //   {
        //     id: 3,
        //     imgSrc: "https://cdn.pixabay.com/photo/2017/08/27/10/16/interior-2685521_960_720.jpg",
        //     imgAlt: "Demo Case Study",
...
<style scoped>
  ...
  .carousel-overlay-explore-items {
    display: flex;
    align-items: center;
    justify-content: space-between;
  }
  .carousel-overlay-explore-item {
    display: flex;
    align-items: center;
    justify-content: space-between;
